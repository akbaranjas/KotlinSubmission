...
interface ApiInterface{
    ...
    fun getMatchList(@Path("key") id: String, @Query("id") leagueId: String): Observable<MatchResponse>

    @GET("/api/v1/json/{key}/eventsnextleague.php")
    fun getNextMatchList(@Path("key") id: String, @Query("id") leagueId: String): Observable<MatchResponse>

    @GET("/api/v1/json/{key}/lookupteam.php")
    fun getTeam(@Path("key") id: String, @Query("id") teamId: String): Observable<TeamResponse>
